...
When you extract data to polygons, like the states of Australia, you havepotentially have a lot of different values within each state, so we have to decide what we want to do with these values
